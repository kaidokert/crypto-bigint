...
impl<T: WrappingAdd + Add<T, Output = T>> Add<Self> for Wrapping<T> {
...
impl<T: WrappingAdd + Add<T, Output = T> + Clone> Add<&Self> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingAdd + Add<T, Output = T> + Clone> Add<Wrapping<T>> for &Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingSub + Sub<T, Output = T>> Sub<Self> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingSub + Sub<T, Output = T> + Clone> Sub<&Self> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingSub + Sub<T, Output = T> + Clone> Sub<Wrapping<T>> for &Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingMul + Mul<T, Output = T>> Mul<Self> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingMul + Mul<T, Output = T> + Clone> Mul<&Self> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingMul + Mul<T, Output = T> + Clone> Mul<Wrapping<T>> for &Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingShl + Shl<usize, Output = T>> Shl<u32> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: WrappingShr + Shr<usize, Output = T>> Shr<u32> for Wrapping<T> {
    type Output = Wrapping<T>;
...
impl<T: num_traits::Zero + WrappingAdd + Add<T, Output = T>> num_traits::Zero for Wrapping<T> {
    #[inline]
    fn zero() -> Self {
        Wrapping(T::zero())
    }
...
impl<T: num_traits::One + WrappingMul + Mul<T, Output = T> + PartialEq> num_traits::One
    for Wrapping<T>
{
    #[inline]
    fn one() -> Self {
