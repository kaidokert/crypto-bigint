...
use crate::{Add, AddAssign, Checked, CheckedAdd, Choice, CtOption, Int, Uint, Wrapping, WrappingAdd};
...
impl<const LIMBS: usize> Int<LIMBS> {
    ...
    pub const fn overflowing_add(&self, rhs: &Self) -> (Self, Choice) {
        // Step 1. add operands
        let res = Self(Uint::wrapping_add(&self.0, &rhs.0));
    ...
    pub const fn wrapping_add(&self, rhs: &Self) -> Self {
        Self(Uint::wrapping_add(&self.0, &rhs.0))
    }
}
